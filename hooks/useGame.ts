...
export const BULLET_COLORS = [
  ...
  { name: "Purple", color: "#A055FF" },
  { name: "Lavender", color: "#A765FF" },
  { name: "Lilac", color: "#AE75FF" },
  { name: "Mauve", color: "#B585FF" },
  { name: "Orchid", color: "#BC95FF" },
  { name: "Periwinkle", color: "#C3A5FF" },
  { name: "Amethyst", color: "#CAB5FF" },
  { name: "Iris", color: "#D1C5FF" },
  { name: "Heather", color: "#D8D5FF" },
  { name: "Sky", color: "#DFE5FF" },
  { name: "Azure", color: "#C5E5FF" },
  { name: "Cerulean", color: "#ABE5FF" },
  { name: "Aqua", color: "#91E5FF" },
  { name: "Turquoise", color: "#77E5FF" },
  { name: "Cyan", color: "#5DE5FF" },
  { name: "Electric", color: "#43D5FF" },
  { name: "Neon", color: "#29C5FF" },
  { name: "Bright", color: "#0FB5FF" },
  { name: "Ocean", color: "#00A5F5" },
  { name: "Deep", color: "#00B5E5" },
  { name: "Teal", color: "#00C5D5" },
  { name: "Mint", color: "#00D5C5" },
  { name: "Jade", color: "#00E5B5" },
  { name: "Emerald", color: "#00F5A5" },
  { name: "Solana", color: "#14F195" },
  { name: "Spring", color: "#24F1A5" },
  { name: "Lime", color: "#34F1B5" },
  { name: "Verdant", color: "#44F1C5" },
  { name: "Seafoam", color: "#54F1D5" },
];
