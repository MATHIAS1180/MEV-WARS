...
const exo2 = Exo_2({ subsets: ["latin"], weight: ["400", "600", "700", "800", "900"], variable: "--font-space" });
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={`${exo2.variable} ${inter.variable} font-sans bg-black text-zinc-100 antialiased min-h-screen flex flex-col selection:bg-[#9945FF]/40 selection:text-white`}>
        <PerformanceFixes />
