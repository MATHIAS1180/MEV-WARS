// MEV Wars - Solana Smart Contract
// Deploy on https://beta.solpg.io
// 
// Features:
// - Unlimited players per block
// - 1 winner per 3 players (e.g., 6 players = 2 winners)
// - 95% prize pool / 5% house edge
// - PRNG via future block hash (provably fair)
...
declare_id!("2DKNipJx8QpQ1BzEScj3YoJ3CwpEbzyeEFVYvPbSsEtV");
